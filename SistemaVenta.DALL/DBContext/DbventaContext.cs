...
namespace SistemaVenta.DALL.DBContext
{
    ...
    public partial class DbventaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CA357D3C6");
            ...
            {
                entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FB5EDA704");
            ...
            {
                entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483E9225934");
            ...
            {
                entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1070969D0BA");
            ...
            {
                entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547E0B8D4252");
            ...
            {
                entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132DF787E57");
            ...
            {
                entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F7691EA4CD1");
            ...
            {
                entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D86893C54C");
            ...
            {
                entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE48386881");
            ...
            {
                entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6ECB1A413");
            ...
            {
                entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614258F0E1D");
